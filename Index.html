<html><meta charset='UTF-8'/><meta content='width=device-width, initial-scale=1, user-scalable=1, minimum-scale=1, maximum-scale=5' name='viewport'/><meta content='IE=edge' http-equiv='X-UA-Compatible'/>
  ...
  <link href="https://feeldreams.github.io/heibukayuk/style.css" rel="stylesheet" type="text/css" />
...
<body>
   ...
   <div id="bodyblur">
     <!-- Wallpaper / Background --><img src="https://feeldreams.github.io/pics/awan/1.jpg" id="wallpaper"/>
   </div>
...
<script src="https://feeldreams.github.io/heibukayuk/script.js"></script>
...
<script type="text/javascript">
       async function jawab(){await swals.fire('baik baik di sana ya mejind');window.location = "#" + pesanwhatsapp;}
       ...
       async function pesan(){
                 ...
                 await swalst.fire({
                  title: 'Semangat Jalani Harindu ya 😊 ',
                  imageUrl: '' + fotoakhir2.src,
                  });
                 await swalst.fire({
                  title: 'Tetap Jaga Kesehatan ya 👍',
                 ...
                 await swalst.fire({
                  ...
                  katangetik = "Aku Cuma Mau Bilang:<br>Kam Gk Boleh Sedih Sedih Ya<br>Semangat Menjalani Hari Harindu Disana<br> Jangan Sakit Sakit🙂";
                  katangetik2 = "Bahagia Selalu"
